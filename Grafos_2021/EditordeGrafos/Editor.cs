...
namespace EditordeGrafos
{
    public partial class Editor : Form
    {
        ...
        public List<NodeP> marcaBFA = new List<NodeP>();
        ...
        public void BosqueProfundidad(Graph graph)
        {
            ...
            marcaBFA[0].Visited = true;
            marcaBFA[0].Nivel = cont;
            foreach (NodeP n in graph)
            {
                foreach (Edge ar in graph.edgesList)
                {
                    if (n.Name == ar.Source.Name)
                    {
                        ...
                        if (n.Visited == false)
                        {
                            ...
                            if (marcaBFA[marcaBFA.Count - 1].Visited == false)
                            {
                                marcaBFA[marcaBFA.Count - 1].Visited = true;
                                n.Nivel = cont + 1;
                                if (ar.Destiny.Visited == false)
                                {
            ...
            {
                //Retroceso
                if (ar.Source.Nivel-2 == ar.Destiny.Nivel || ar.Source.Nivel - 4 == ar.Destiny.Nivel)
                    cadena1 += " (" + ar.Source.Name + "->" + ar.Destiny.Name + ") " ;

                //Avance 
                 if (ar.Source.Nivel  == ar.Destiny.Nivel - 3)
                    cadena2 += " (" + ar.Source.Name + "->" + ar.Destiny.Name + ") ";
                //Arbol
                if (ar.Source.Nivel + 1 == ar.Destiny.Nivel)
                    cadena3 += " (" + ar.Source.Name + "->" + ar.Destiny.Name + ") ";
                //cruce

                if (ar.Source.Nivel == ar.Destiny.Nivel -4 || ar.Source.Nivel == ar.Destiny.Nivel - 5)
